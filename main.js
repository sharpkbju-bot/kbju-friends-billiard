...
let infoModalAutoCloseTimeout = null; // v6.00 신규 추가 10초 타이머
...
function showRingCriteria(type) {
    ...
    if(timerEl) {
        ...
        timerEl.innerText = "10초 후 자동으로 닫힙니다.";
    }
    ...
    if (infoModalAutoCloseTimeout) clearTimeout(infoModalAutoCloseTimeout);
    infoModalAutoCloseTimeout = setTimeout(() => {
        closeInfoModal();
    }, 10000);
}
...
function closeInfoModal() { 
    ...
    if (infoModalAutoCloseTimeout) {
        clearTimeout(infoModalAutoCloseTimeout);
        infoModalAutoCloseTimeout = null;
    }
}
