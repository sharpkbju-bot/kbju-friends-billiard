...
// 링 그래프 원주 및 오프셋 계산 (반지름 36px 기준 원주율 2 * PI * 36 = 226)
const circ = 226;
...
// 링 그래프 HTML 삽입 (애니메이션 처리를 위해 초기 dashoffset을 최대로 설정하고 data-offset에 목표값 저장)
...
// [핵심 해결] DOMContentLoaded를 사용하여 무거운 리소스(배경 등) 로딩 대기 현상 방지
document.addEventListener('DOMContentLoaded', () => {
// 웰컴 스크린 제거: 스크립트 실행 직후 무조건 3초 뒤 종료 보장
setTimeout(() => {
