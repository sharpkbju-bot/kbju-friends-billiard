...
function searchRecords() {
    ...
    sArea.innerHTML = `<div class="summary-box" style="margin: 0 -5px; box-sizing: border-box; background:var(--record-bg); border:2px solid var(--record-border); border-radius:15px; padding:15px 10px;">
                           ...
                           <div style="display: flex; justify-content: space-around; text-align: center; margin-bottom: 12px;">
                               <div><div style="font-size: 11px; font-weight: 800; color: var(--sub-text); margin-bottom: 4px;">참여</div><div style="font-size: 14px; font-weight: 900; color: var(--text-color);">${filtered.length}전</div></div>
                               <div><div style="font-size: 11px; font-weight: 800; color: var(--rank1); margin-bottom: 4px;">1위</div><div style="font-size: 14px; font-weight: 900; color: var(--rank1);">${r[0]}승</div></div>
                               <div><div style="font-size: 11px; font-weight: 800; color: var(--rank4); margin-bottom: 4px;">기타</div><div style="font-size: 14px; font-weight: 900; color: var(--rank4);">${othersCount}회</div></div>
                               <div><div style="font-size: 11px; font-weight: 800; color: var(--rankL); margin-bottom: 4px;">꼴찌</div><div style="font-size: 14px; font-weight: 900; color: var(--rankL);">${r[4]}회</div></div>
                               <div><div style="font-size: 11px; font-weight: 800; color: var(--success); margin-bottom: 4px;">승률</div><div style="font-size: 14px; font-weight: 900; color: var(--success);">${winRateFloat}%</div></div>
                           </div>
                           <div style="border-top: 1px dashed var(--record-border); margin: 12px 0;"></div>
                           <div style="display: flex; justify-content: space-around; text-align: center;">
                               <div><div style="font-size: 11px; font-weight: 800; color: var(--sub-text); margin-bottom: 4px;">월간순위</div><div style="font-size: 14px; font-weight: 900; color: var(--rankL);">${myMonthlyRank}위</div></div>
                               <div><div style="font-size: 11px; font-weight: 800; color: var(--sub-text); margin-bottom: 4px;">승점 <span style="font-size:9px;">(평균)</span></div><div style="font-size: 14px; font-weight: 900; color: var(--text-color);">${monthlyTotalScore}점 <span style="font-size:11px; color:var(--sub-text);">(${monthlyAvgScore})</span></div></div>
                               <div><div style="font-size: 11px; font-weight: 800; color: var(--sub-text); margin-bottom: 4px;">티어</div><div style="font-size: 14px; font-weight: 900; color: ${tier.color};">${tier.icon}${tier.name}</div></div>
                               <div><div style="font-size: 11px; font-weight: 800; color: var(--sub-text); margin-bottom: 4px;">컨디션</div><div style="font-size: 14px; font-weight: 900; color: ${cond[2]};">${cond[0]}${cond[1]}</div></div>
                           </div>
                       </div>`;
