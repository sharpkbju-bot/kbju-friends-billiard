...
// [v5.60 Fix] 리셋 버튼 클릭 시 모든 검색 데이터와 결과를 초기화하는 함수
...
function searchRecords() { /* 기록 검색 로직 */ }

// [핵심 방어책] 웰컴 화면 강제 종료 타이머 (window.onload에 의존하지 않고 독립 실행)
setTimeout(() => {
...
const toast = document.getElementById('toast');
if(toast) {
toast.innerText = "게임 기록 없음"; toast.style.display = 'block';
